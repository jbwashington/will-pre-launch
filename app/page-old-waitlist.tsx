...
import { preloadModelInBackground, preloadOnInteraction } from "@/lib/ai/preloader"
...
export default function Home() {
  ...
  useEffect(() => {
    // Strategy 1: Start preload after page is interactive (idle time)
    preloadModelInBackground()

    // Strategy 2: Also preload on shop link hover/focus
    if (shopLinkRef.current) {
      preloadOnInteraction(shopLinkRef.current)
    }
  }, [])
              ...
              >
                {!showWaitlist ? (
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <Link href="/shop" ref={shopLinkRef}>
                      <Button
                        size="lg"
                        variant="outline"
